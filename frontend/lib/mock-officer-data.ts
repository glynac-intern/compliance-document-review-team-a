...
export const MOCK_QUEUE_DOCUMENTS: ComplianceDocument[] = [
  ...
  },
  {
    ...
    version: 1,
    file_size_mb: 5.2,
    officer_feedback: "All disclosures present. Approved for distribution.",
  ...
  },
  {
    ...
    file_reference: "s3://compliance-vault/docs/2026/DOC-2026-0868.docx",
    ...
    file_size_mb: 0.8,
    officer_feedback:
      "Remove performance guarantees from social copy. Add required FINRA disclaimer for social media communications.",
    officer_name: "Sarah Jenkins",
  ...
  },
  {
    ...
    advisor_email: "m.chen@apexadvisory.com",
    status: "rejected",
    file_reference: "s3://compliance-vault/docs/2026/DOC-2026-0861.pdf",
    type: "Presentation / Deck",
    ...
    file_size_mb: 6.1,
    officer_feedback:
      "Contains materially misleading risk ratings. Internal methodology cannot be shared with clients without full regulatory review.",
    officer_name: "Sarah Jenkins",
  ...
  },
  {
    ...
    advisor_email: "e.rostova@apexadvisory.com",
    status: "approved",
    file_reference: "s3://compliance-vault/docs/2026/DOC-2026-0855.xlsx",
    type: "Performance Factsheet",
    ...
    version: 2,
    file_size_mb: 3.9,
    officer_feedback: "Revision addresses prior concerns. Performance disclaimers now present.",
    officer_name: "Sarah Jenkins",
...
/**
 * Cross-firm regulatory audit trail records for compliance recordkeeping.
 * Complying with SEC Rule 204-2 and FINRA Rule 4511.
 */
...
export const MOCK_AUDIT_LOG_ENTRIES: AuditLogEntry[] = [
  {
    id: "AUD-2026-9041",
    timestamp: "2026-09-13T18:32:10Z",
    actor_name: "Sarah Jenkins",
    actor_role: "Compliance Officer",
    action_type: "DECISION_APPROVED",
    document_id: "DOC-2026-0872",
    document_title: "2026 Wealth Management Capabilities Brochure.pdf",
    details: "Rendered formal approval determination with supervisory verification statement.",
    ip_address: "192.168.4.12",
    hash_signature: "a4f89b71e3d0c9214f88",
  },
  {
    id: "AUD-2026-9038",
    timestamp: "2026-09-13T16:15:44Z",
    actor_name: "System (Verity AI Engine)",
    actor_role: "Automated Screening",
    action_type: "AI_SCAN_COMPLETED",
    document_id: "DOC-2026-0891",
    document_title: "Q1 2026 Alpha Growth Fund Presentation.pdf",
    details: "Completed regulatory screening in 2.4s. Identified 2 High severity and 1 Medium severity risk flags.",
    ip_address: "10.0.12.88",
    hash_signature: "e7c21a980ff432d8109b",
  },
  {
    id: "AUD-2026-9035",
    timestamp: "2026-09-13T15:20:00Z",
    actor_name: "Jonathan Vance",
    actor_role: "Financial Advisor",
    action_type: "DOCUMENT_SUBMITTED",
    document_id: "DOC-2026-0891",
    document_title: "Q1 2026 Alpha Growth Fund Presentation.pdf",
    details: "Initial submission of 24-slide marketing presentation for retail investor distribution.",
    ip_address: "192.168.2.45",
    hash_signature: "98ab01c5f834d9203ee1",
  },
  {
    id: "AUD-2026-9029",
    timestamp: "2026-09-13T11:45:18Z",
    actor_name: "Sarah Jenkins",
    actor_role: "Compliance Officer",
    action_type: "FILE_DOWNLOADED",
    document_id: "DOC-2026-0887",
    document_title: "Emerging Markets Quarterly Outlook.pdf",
    details: "Downloaded document package for offline legal & regulatory counsel review.",
    ip_address: "192.168.4.12",
    hash_signature: "77cd44a19b8823f001ca",
  },
  {
    id: "AUD-2026-9024",
    ...
    document_id: "DOC-2026-0868",
    document_title: "Social Media Campaign - September Launch.docx",
    details: "Requested revision: Remove performance guarantees and append FINRA 2210 disclaimer.",
    ip_address: "192.168.4.12",
    hash_signature: "33fe88c910aa74b21d55",
  },
  {
    id: "AUD-2026-9018",
    timestamp: "2026-09-12T14:10:22Z",
    actor_name: "Elena Rostova",
    actor_role: "Financial Advisor",
    action_type: "REVISION_UPLOADED",
    document_id: "DOC-2026-0855",
    document_title: "Mid-Year Performance Summary Report.xlsx",
    details: "Uploaded revision version 2 addressing benchmark disclosure requirements.",
    ip_address: "192.168.3.18",
    hash_signature: "10cb9948ef23d8719ac4",
  },
  {
    id: "AUD-2026-9012",
    timestamp: "2026-09-11T13:05:30Z",
    actor_name: "Sarah Jenkins",
    actor_role: "Compliance Officer",
    action_type: "DECISION_REJECTED",
    document_id: "DOC-2026-0861",
    document_title: "Client Risk Assessment Methodology.pdf",
    details: "Regulatory rejection rendered: Internal risk ratings are not authorized for retail distribution.",
    ip_address: "192.168.4.12",
    hash_signature: "55ea004128dd84c987fa",
  },
  {
    id: "AUD-2026-9005",
    timestamp: "2026-09-11T09:30:12Z",
    actor_name: "System (Verity AI Engine)",
    actor_role: "Automated Screening",
    action_type: "AI_SCAN_COMPLETED",
    document_id: "DOC-2026-0884",
    document_title: "Retirement Horizons Client Newsletter - March 2026.docx",
    details: "Identified 1 Medium severity risk flag regarding Form CRS disclosure placement.",
    ip_address: "10.0.12.88",
    hash_signature: "66fd771239aa841029bb",
  },
  {
    id: "AUD-2026-8998",
    timestamp: "2026-09-10T15:22:45Z",
    actor_name: "Marcus Chen",
    actor_role: "Financial Advisor",
    action_type: "DOCUMENT_SUBMITTED",
    document_id: "DOC-2026-0887",
    document_title: "Emerging Markets Quarterly Outlook.pdf",
    details: "Initial submission of emerging markets commentary for client distribution.",
    ip_address: "192.168.5.91",
    hash_signature: "88ab11ef4432c09188dd",
  },
  {
    id: "AUD-2026-8991",
    ...
    actor_role: "Compliance Officer",
    action_type: "DECISION_APPROVED",
    document_id: "DOC-2026-0849",
    document_title: "ESG Impact Investment Guide 2026.pdf",
    details: "Supervisory determination rendered: APPROVED. Meets SEC ESG disclosure standards.",
    ip_address: "192.168.4.12",
    hash_signature: "44ef9011aa3278c566ba",
  },
];
