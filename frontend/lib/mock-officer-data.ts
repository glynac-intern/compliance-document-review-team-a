...
/**
 * Audit trail entries for regulatory recordkeeping.
...
export const MOCK_AUDIT_LOG_ENTRIES: AuditLogEntry[] = [
  {
    ...
    details: "Approved for retail investor distribution.",
  ...
  },
  {
    ...
    actor_name: "Verity AI",
    actor_role: "AI Review",
    action_type: "AI_SCAN_COMPLETED",
    document_id: "DOC-2026-0891",
    document_title: "Q1 2026 Alpha Growth Fund Presentation.pdf",
    details: "Completed review. Flagged 2 high-risk and 1 medium-risk items for officer review.",
  ...
  },
  {
    ...
    document_id: "DOC-2026-0891",
    document_title: "Q1 2026 Alpha Growth Fund Presentation.pdf",
    details: "Initial submission of presentation for compliance review.",
  ...
  },
  {
    ...
    details: "Downloaded document for offline legal & regulatory review.",
    ip_address: "192.168.4.12",
  ...
  },
  {
    ...
    details: "Revision requested: Remove promissory returns and add FINRA 2210 disclaimer.",
    ip_address: "192.168.4.12",
  ...
  },
  {
    ...
    details: "Uploaded revision (v2) with required benchmark disclosures.",
  ...
  },
  {
    ...
    details: "Rejected: Internal risk ratings not authorized for retail distribution.",
    ip_address: "192.168.4.12",
  ...
  },
  {
    ...
    details: "Completed review. Flagged 1 medium-risk item regarding Form CRS disclosure.",
    ip_address: "10.0.12.88",
  ...
  },
  {
    ...
    document_id: "DOC-2026-0887",
    document_title: "Emerging Markets Quarterly Outlook.pdf",
    details: "Initial submission of market commentary for review.",
  ...
  },
  {
    ...
    details: "Approved: Meets SEC ESG disclosure standards.",
    ip_address: "192.168.4.12",
